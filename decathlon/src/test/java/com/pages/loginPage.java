...
public class loginPage 
{
	...
	{		
		switch (iterator)
		{
			case 1: if(driver.findElements(By.xpath("//div[text()='Authentication failed']")).size() != 0 )
					{
						...
						excel.writeExcelData("Sheet1",iterator, 3, driver.findElement(By.xpath("//div[text()='Authentication failed']")).getText(),"blue");
					}
					break;
			...
			case 2: if(driver.findElements(By.xpath("//div[text()='Password can not be empty.']")).size() != 0 )
			{
				...
				excel.writeExcelData("Sheet1",iterator, 3, driver.findElement(By.xpath("//div[text()='Password can not be empty.']")).getText(),"blue");
			}
					break;
			...
			case 3: if(driver.findElements(By.xpath("//div[text()='Please enter your Email.']")).size() != 0 )
			{
				...
				excel.writeExcelData("Sheet1",iterator, 3, driver.findElement(By.xpath("//div[text()='Please enter your Email.']")).getText(),"blue");
			}
					break;
			...
			case 5: excel.writeExcelData("Sheet1",iterator, 3, "Successfully Login.","blue");
					break;				
		}
	}
	...
	public void setSTATUS() throws IOException 
	{
		switch (iterator) 
		{
			case 1: if((excel.readExcelData("Sheet1", iterator, 2)).equalsIgnoreCase(excel.readExcelData("Sheet1", iterator, 3)))
						excel.writeExcelData("Sheet1", iterator, 4, "PASS", "green");
					else
						excel.writeExcelData("Sheet1", iterator, 4, "FAIL", "red");
					break;
					
			case 2: if((excel.readExcelData("Sheet1", iterator, 2)).equalsIgnoreCase(excel.readExcelData("Sheet1", iterator, 3)))
						excel.writeExcelData("Sheet1", iterator, 4, "PASS", "green");
					else
						excel.writeExcelData("Sheet1", iterator, 4, "FAIL", "red");
					break;
			
			case 3: if((excel.readExcelData("Sheet1", iterator, 2)).equalsIgnoreCase(excel.readExcelData("Sheet1", iterator, 3)))
						excel.writeExcelData("Sheet1", iterator, 4, "PASS", "green");
					else
						excel.writeExcelData("Sheet1", iterator, 4, "FAIL", "red");
					break;
			
			case 4: if((excel.readExcelData("Sheet1", iterator, 2)).equalsIgnoreCase(excel.readExcelData("Sheet1", iterator, 3)))
						excel.writeExcelData("Sheet1", iterator, 4, "PASS", "green");
					else
						excel.writeExcelData("Sheet1", iterator, 4, "FAIL", "red");
					break;
					
			case 5: if((excel.readExcelData("Sheet1", iterator, 2)).equalsIgnoreCase(excel.readExcelData("Sheet1", iterator, 3)))
						excel.writeExcelData("Sheet1", iterator, 4, "PASS", "green");
					else
						excel.writeExcelData("Sheet1", iterator, 4, "FAIL", "red");
					break;
